...
const Search = ({ setImages }) => {
  ...
  const handleSearchInput = (e) => {
    if (searchQuery.length && e.key === "Enter") submit(e, 'b')
  }
  ...
  return (
    <div className="flex justify-center my-20">
      ...
      />
      <a href="" onClick={(e) => submit(e, 'a')} className="relative inline-block text-lg group mx-2">
        <span className="relative z-10 block px-3.5 py-2 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-200 rounded-lg group-hover:text-white">
